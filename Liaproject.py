...
def fan_number_calc(df_for_calc,room_length, room_width):
    ...
    df_for_calc['Number of fans along width'] = df_for_calc['Fan Diameter (coverage)'].div(1.4*room_width)
    df_for_calc['Number of fans along along length'] = df_for_calc['Fan Diameter (coverage)'].div(1.4*room_length)
