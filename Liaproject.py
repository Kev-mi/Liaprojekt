...
def fan_number_calc(df_for_calc,room_length, room_width):
    ...
    df_for_calc['Number of fans along width'] = df_for_calc['Number of fans along width'].div(df_for_calc['Fan Diameter (coverage)'].values,axis=0).div(float(0.64)).apply(np.floor)
    df_for_calc['Number of fans along along length'] = df_for_calc['Number of fans along along length'].div(df_for_calc['Fan Diameter (coverage)'].values,axis=0).div(float(0.64)).apply(np.floor)
